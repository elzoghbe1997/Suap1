...
const INITIAL_TRANSACTIONS: Omit<Transaction, 'id'>[] = [
    ...
    { date: '2024-01-10', description: 'بيع أول دفعة محصول طماطم', type: TransactionType.REVENUE, category: 'أخرى', amount: 15000, cropCycleId: tempCycleId1, quantity: 500, priceItems: [{ quantity: 500, price: 30 }], market: 'العبور' },
    { date: '2024-02-05', description: 'بيع ثاني دفعة محصول طماطم', type: TransactionType.REVENUE, category: 'أخرى', amount: 22000, cropCycleId: tempCycleId1, quantity: 750, priceItems: [{ quantity: 500, price: 30 }, { quantity: 250, price: 28 }], market: 'المستقبل' },
    ...
    { date: getPastDate(5), description: 'بيع محصول خيار مبكر', type: TransactionType.REVENUE, category: 'أخرى', amount: 9500, cropCycleId: tempCycleId2, quantity: 400, priceItems: [{ quantity: 400, price: 25 }], discount: 500, market: 'العبور' },
...
export const getDemoData = (): BackupData => {
    // Note: The temp IDs are just for in-memory relationships before insertion.
    // The actual relationships will be based on the IDs generated by Supabase.
